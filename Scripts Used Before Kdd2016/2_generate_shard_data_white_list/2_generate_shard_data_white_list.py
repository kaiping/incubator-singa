# This is the code when we add the functionality of White Listimport sys
import numpy as np
import random
...
if __name__ == '__main__':
    ...
    #test_index = -1 #deprecated: randomly picking # Use -1 to represent random sampling, NEVER change this value
    label_feature = 'MMSCORE'
    test_file_path = 'test.shard'
    valid_file_path = 'valid.shard'
    train_file_path = 'train.shard'

    # only consider those viscode involved white list, None means all valid viscodes beside cutpoint.
